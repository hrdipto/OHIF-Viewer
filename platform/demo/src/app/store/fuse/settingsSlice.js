...
export function generateSettings(_defaultSettings, _newSettings) {
  const x =
    _newSettings &&
    _newSettings.layout &&
    _newSettings.layout.style &&
    FuseLayoutConfigs[_newSettings.layout.style] &&
    FuseLayoutConfigs[_newSettings.layout.style].defaults;
...
export const selectFuseThemeById = id =>
  createSelector(
    ...
    (themes, direction) => generateMuiTheme(themes, id, direction)
  );
