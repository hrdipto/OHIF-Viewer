...
const FusePageSimpleForReportList = React.forwardRef((props, ref) => {
	...
	return (
		<div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
			...
			<div className="flex flex-auto flex-col container z-10 h-full" style={{ width: 'auto' }}>
...
FusePageSimpleForReportList.propTypes = {
...
FusePageSimpleForReportList.defaultProps = {};

export default React.memo(FusePageSimpleForReportList);
